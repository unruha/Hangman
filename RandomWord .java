...
public class RandomWord {
	...
	hardware, identifier, Java, logic, loops, machine, memory, interfaces, 
	nested, primitive, processor, software, syntax, classes}; 
	...
	public static void populateWORD_ARRAY()
	{
		...
		for(WordBank w: WordBank.values())
		{
			WORD_ARRAY[i] = w.toString();
			i++;
		}
